...
from pyspark.sql.types import StructType as R, StructField as Fld, TimestampType as Ts, IntegerType as Int, DateType as Date
...
def process_song_data(spark, input_data, output_data):
    """
    Description:
        The function processes the raw songs data files and creates songs and artist dimension tables.
...
def process_log_data(spark, input_data, output_data):
    """
    Description:
            The function processes the raw log data files and creates songplays fact table and users, and time dimension tables.
    :param spark: spark session instance
    :param input_data: input file path
    :param output_data: output file path
    """
...
def main():
    ...
    input_data = "s3://spark-dataLakes/"
    output_data = "s3://spark-dataLakes/output/"
